...
const Home = () => {
  ...
  return (
    <>
      <SEOMetadata 
        title="Premium UK Health & Nutrition Supplements | Research-Backed Formulas"
        description="Discover premium UK nutrition supplements crafted by PhD scientists. Expert-formulated vitamins, minerals & wellness products with proven bioavailability. Compare prices and find better value."
        keywords="UK nutrition supplements, premium supplements, health supplements, wellness products, vitamins UK, minerals, compare supplements, supplement alternatives, best supplement prices"
        ...
        <div className="max-w-6xl mx-auto px-6 py-16 md:py-20 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 text-white">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
                Premium UK Nutrition Supplements at Better Value
            </h1>
            <p className="text-xl md:text-2xl opacity-90 mb-8">
                Research-backed formulas with proven bioavailability. Compare and save on your wellness journey.
            </p>
